...
<main>
    <article>
        ...
        <section class="section works text-center" aria-labelledby="work-label" >
            <div class="container">
               <h2 class="h2 title section-title">Teaching & Acedamic Courses </h2>
               ...
               <ul class="grid-list">
                <li>
                    <div class="work-card">
                        <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                            <img src="images/NTT.png" alt="Product Design" 
                            class="img-cover" width="580" height="700" loading="lazy">
                        </figure>
                        <h3 class="h3 title">
                            <a href="" class="card-title">Nursery Teacher Training</a>
                        </h3>
                        <p class="card-text">Nursery Teacher Training is a one-year-long diploma course that deals with the education of the nursery level teacher workforce.
                          The NTT course offers an ample amount of jobs to students.</p>
                    </div>
                ...
                <li>
                    <div class="work-card">
                        <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                            <img src="images/PTC.png" alt="Product Design" 
                            class="img-cover" width="580" height="700" loading="lazy">
                        </figure>
                        <h3 class="h3 title">
                            <a href="" class="card-title">Primary Teachers Cert</a>
                        </h3>
                        <p class="card-text">Diploma in Primary Teacher Course, The main aim of PTC program is to cater to the Pre & Primary  level teacher workforce in Pakistan.
                          It also equips the prospective Pre and Primary teachers with the vital skills.</p>
                    </div>
                    <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                </li>
                   ...
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/ETE.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Elementary Teacher Edu</a>
                           </h3>
                           <p class="card-text">(ETE) students can prepare for teacher certification in two specialty areas without any additional years of study: elementary education and one of six concentration areas, 
                            including English as a second language.</p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   ...
                   <li>
                    <div class="work-card">
                        <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                            <img src="images/BTC.png" alt="Product Design" 
                            class="img-cover" width="580" height="700" loading="lazy">
                        </figure>
                        <h3 class="h3 title">
                            <a href="" class="card-title">Basic Training Certificate</a>
                        </h3>
                        <p class="card-text">BTC is a mandatory training certificate required for those planning to teach in govt. primary schools. 
                         The main aim of the programme is training teachers for imparting primary education.</p>
                    </div>
                    <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                </li>       
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/DED.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Diploma in Education</a>
                           </h3>
                           <p class="card-text">DEd or Diploma in Education is a certificate-level teacher training programme that equips candidates to become nursery school teachers. 
                            The course basically caters to elementary-level education in Pakistan</p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/TTC.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Teachers Training Cert</a>
                           </h3>
                           <p class="card-text"> The course comprises basic knowledge about early childhood teaching methods and effective techniques. 
                            Preparing the aspiring teachers with required skills is the primary goal of the course.</p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>           
               </ul>
