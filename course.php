               ...
               <ul class="grid-list">
                   <li>
                       <div class="work-card">
                           ...
                           <h3 class="h3 title">
                               <a href="Teaching.php" class="card-title">Teaching & Acedamic</a>
                           </h3>
                   ...
                   <li>
                       <div class="work-card">
                           ...
                           <h3 class="h3 title">
                               <a href="IT-Course.php" class="card-title">IT Course</a>
                           </h3>
                   ...
                   <li>
                       <div class="work-card">
                           ...
                           <h3 class="h3 title">
                               <a href="Healthcare.php" class="card-title">Health Course</a>
                           </h3>
                           <p class="card-text">Teaching is the process of attending to people's needs, experiences and feelings, and intervening 
                               so that they learn particular things, and go beyond the given.</p>
                       </div>
                   ...
                   <li>
                       <div class="work-card">
                           ...
                           <h3 class="h3 title">
                               <a href="languages.php" class="card-title">Language Course</a>
                           </h3>
                   ...
                   <li>
                       <div class="work-card">
                           ...
                           <h3 class="h3 title">
                               <a href="management.php" class="card-title">Management Course</a>
                           </h3>
                   ...
                   <li>
                       <div class="work-card">
                           ...
                           <h3 class="h3 title">
                               <a href="business.php" class="card-title">Business Course</a>
                           </h3>
                           <p class="card-text">Management can neither be replaced nor substituted by anything else.
                               Even the computer which is the wonderful invention of the twentieth century  
                                management.</p>
