...
<main>
    <article>
        ...
        <section class="section works text-center" aria-labelledby="work-label" >
            <div class="container">
               <h2 class="h2 title section-title">Management Courses </h2>
               ...
               <ul class="grid-list">
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/project.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Project Management</a>
                           </h3>
                           <p class="card-text">Undertaking the responsibility of a project comes with stimulating challenges and relentless hard work. Management as a discipline of study has sprouted into varied
                             interdisciplinary specialization as it blended with many other areas of study.  </p>
                       </div>
                   ...
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/market.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Marketing Management</a>
                           </h3>
                           <p class="card-text">Marketing management is a process of controlling the marketing aspects, setting the goals of a company, organizing the plans step by step, taking decisions for the firm, 
                            and executing them to get the maximum turn over by meeting the consumers' demands.  </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/office.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Office Management</a>
                           </h3>
                           <p class="card-text">These free online office management courses include all the relevant information you need to excel in office management.Organisation, and planning of the office, office
                             management is geared towards improving the efficiency of officework in any business. </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>       
               </ul>
