...
<main>
    <article>
        ...
        <section class="section works text-center" aria-labelledby="work-label" >
            <div class="container">
               <h2 class="h2 title section-title">Languages Courses </h2>
               ...
               <ul class="grid-list">
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/English.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">English Language</a>
                           </h3>
                           <p class="card-text">This diploma course provides a fascinating overview of the English language and its cultural treasures. English is worth knowing for practical 
                            reasons like its long reach and is also rich in history and literature. </p>
                       </div>
                   ...
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/speech.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Speech Therapy</a>
                           </h3>
                           <p class="card-text">This course was designed to teach you how to manage stuttering and other speech and language disorders, 
                            build confidence and reduce anxiety in those with these impediments.  </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/communication.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Communication Skills</a>
                           </h3>
                           <p class="card-text">Effective communication has become the need of the hour. No matter what skills you posses, you need to work on
                             your English Communication if you want to get ahead in life.ask questions from your seniors </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>       
               </ul>
