...
<main>
    <article>
        ...
        <section class="section works text-center" aria-labelledby="work-label" >
            <div class="container">
               <h2 class="h2 title section-title">IT Courses </h2>
               ...
               <ul class="grid-list">
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/DATA SCIENCE.jpg.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Data Science Course</a>
                           </h3>
                           <p class="card-text">Data Science is a program which familiarises students with the basic foundational concepts of data algorithms, structures, 
                            python programming, statistical foundations, machine learning and more.</p>
                       </div>
                   ...
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/Cloud Computing.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Cloud Computing Course</a>
                           </h3>
                           <p class="card-text">Cloud computing is changing the hiring pattern in the IT industry. In the coming days, IT companies will replace professionals having 
                            generic skills with those having cloud computing expertise.</p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/Cyber Security.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Cyber Security Course</a>
                           </h3>
                           <p class="card-text">Learn the cybersecurity skills that will make you stand out from your peers—from ethical hacking essentials and fundamentals of programming to advanced penetration testing and digital forensics. 
                            </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/DEV OPS.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">DevOps Course</a>
                           </h3>
                           <p class="card-text">DevOps is the most demanding technology in the IT industry with the highest annual pay. It is a continuous method which involves 
                            many popular tools like Puppet, Docker, and Chef etc.</p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>        
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/IOT.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Internet of Things</a>
                           </h3>
                           <p class="card-text">IoT is a fast becoming an important part of our lives. The world is changing at an incredible pace, 
                            with the number of IoT devices increasing by 31 per cent year over year. Enroll Now in this course.</p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/Full Stack.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Full-stack Developer</a>
                           </h3>
                           <p class="card-text"> Full-stack developers are the developers who are assigned with the task of designing complete apps and websites. These developers work on all surface of development.
                            </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>           
