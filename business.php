    ...
    <div class="container">
        ...
        <nav class="navbar" data-navbar>
            ...
            <ul class="navbar-list">
               ...
               <li>
                <a href="about.html" target="_blank" class="navbar-link">About</a>
               </li>
               <li>
                <a href="course.html" target="_blank" class="navbar-link">Course</a>
               </li>
               <li>
                <a href="Contact-Form.html" target="_blank" class="navbar-link">Contact Us</a>
               </li>
            </ul>
...
<main>
    <article>
        ...
        <section class="section works text-center" aria-labelledby="work-label" >
            <div class="container">
               <h2 class="h2 title section-title">Business Courses </h2>
               ...
               <ul class="grid-list">
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/business.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Business Foundations</a>
                           </h3>
                           <p class="card-text">In this Specialization, you’ll develop basic literacy in the language of business, which you can use to transition to a new career,
                             start or improve your own small business, or apply to business school to continue your education.   </p>
                       </div>
                   ...
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/analysis.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Business Analyst</a>
                           </h3>
                           <p class="card-text">Business Analyst certification training by Mindmajix will help you learn business analyst concepts and master business analysis planning, 
                            strategy analysis, SDLC, STLC, and software testing types. </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>
                   <li>
                       <div class="work-card">
                           <figure class="card-banner  img-holder" style="--width:580; --heigt:700;">
                               <img src="images/finance.png" alt="Product Design" 
                               class="img-cover" width="580" height="700" loading="lazy">
                           </figure>
                           <h3 class="h3 title">
                               <a href="" class="card-title">Financial Accounting</a>
                           </h3>
                           <p class="card-text">How do investors, creditors, and other users analyze financial statements to assess corporate performance? Learn financial accounting, 
                            how to read financial statements, and how to gather inputs to valuation models. </p>
                       </div>
                       <button type="submit" class="btn btn-primary"><a href="pricing.php">Enroll Now</a></button>
                   </li>       
               </ul>
